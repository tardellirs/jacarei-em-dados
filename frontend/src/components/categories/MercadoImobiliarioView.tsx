...
function SummaryCard({
  ...
  return (
    <div className={[
      ...
      <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wide font-medium mb-0.5">{label}</p>
      <p className={[
...
export function MercadoImobiliarioView({ data }: Props) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* ── Tabela de Oportunidades + Pirâmide em grid 2 colunas ── */}
      {brackets.length > 0 && (
        <div className="@container">
          <div className="grid grid-cols-1 @min-[600px]:grid-cols-2 gap-3">

            {/* Coluna esquerda: Tabela de Oportunidades */}
            <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 p-3">
            ...
            {/* Coluna direita: Pirâmide Demanda × Oferta */}
            <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 p-3">
